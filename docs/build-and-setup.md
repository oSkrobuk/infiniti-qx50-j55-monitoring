...
Корпус для дисплея 1,3″ можно напечатать на 3D-принтере:

- [первая версия корпуса](../stl/full_v1_1.3in_display.stl)
- измененная версия: [корпус микроконтроллера](../stl/mc_housing_v2) и
  [корпус дисплея](../stl/display_housing_v2_1.3in)
...
«2. Системные параметры». Если по документации конкретного модуля BLK является прямым выводом питания
...
Яркость встроенной подсветки WT32-SC01 Plus регулируется прошивкой через аппаратный BL_PWM на GPIO 45.

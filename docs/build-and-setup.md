...
| Вывод WVCMCU-230 | Подключение |
|------------------|------------|
| CTX | GPIO 32 |
| CRX | GPIO 34 |
| VCC | 3,3 В |
| GND | GND |
| CANH | контакт 6 OBD-II |
| CANL | контакт 14 OBD-II |

Скорость CAN — 500 кбит/с. На WT32-SC01 Plus GPIO 32 и GPIO 34 доступны на разъёме расширения.

### Пассивный бузер

Сигнальный вывод подключается к GPIO 26, второй вывод — к GND. Для схемы с транзистором 2N5551
используется резистор 1 кОм. GPIO 26 платы WT32-SC01 Plus доступен на разъёме расширения.

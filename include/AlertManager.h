...
struct AlertLogEntry {
    ...
    char     description[64]; // Описание на английском
...
struct CheckDef {
    ...
    const char *description;  // Расшифровка на английском
...
public:
    ...
    static constexpr uint8_t CHECK_COUNT = 8;
...
private:
    ...
    char     active_desc_[64];            // Описание активного алерта

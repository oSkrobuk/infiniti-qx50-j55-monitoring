...
![ESP32 Flash Download Tool](docs/preview.png)
...
2. Измененная от [Александра](https://t.me/Decim88): [корпус МК](stl/mc_housing_v2), [корпус дисплея](stl/display_housing_v2). Отличается переносом и углублением отверстий под провода, дополнительным их зажимом на крышке МК, а так же простым креплением дисплея в дефлектор 

...
| **E-COOL** | `coolant` | Температура охлаждающей жидкости (антифриз ДВС) |
| **R-COOL** | `radiator` | Температура антифриза на выходе радиатора |
...
| 🟢 Зелёный | Рабочая температура (целевая) |
| 🔴 Красный | Достигнут максимум — перегрев |

...
| `/checks.json` | Конфиг проверок алертов (режим повтора + пороги) |
...
- Переключить режим срабатывания (toggle): **«При постоянной ошибке повтор раз в 15 сек»** или **«Однократно, пока код в журнале»**.

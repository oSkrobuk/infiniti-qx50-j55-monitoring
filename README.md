...
3. В процессе работы устройство выводит отладочную информацию: состояние CAN-шины, принятые UDS-ответы, значения датчиков.
...
| `spiffs`  | data/spiffs | `0x390000` | 448 KB | Файловая система (конфиг) |
...
## 9. UDS-опрос (техническая справка)
...
## 10. Сборка из исходников (PlatformIO)

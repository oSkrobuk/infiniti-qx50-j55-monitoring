...
| **DC-DC** | Преобразователь напряжения 12-24V в 5V |
...
- Файл `firmware.bin` новой версии (из релиза или собранный PlatformIO: `.pio/build/esp32doit-devkit-v1/firmware.bin`).
...
Флеш-память ESP32 (4 MB) разделена на два одинаковых слота прошивки:

| Раздел | Тип | Смещение | Размер | Назначение |
|--------|-----|----------|--------|-----------|
| `otadata` | data/ota | `0x0E000` | 8 KB | Указывает, какой слот загрузить |
| `ota_0` | app/ota_0 | `0x10000` | 1.75 MB | Слот A |
| `ota_1` | app/ota_1 | `0x1D0000` | 1.75 MB | Слот B |
| `spiffs` | data/spiffs | `0x390000` | 448 KB | Файловая система |

...
// тест двигает его руками. Благодаря этому тайминги алертов (подтверждение
// условия, интервал повтора) и время показа оверлея (ALERT_DISPLAY_MS)
// проверяются детерминированно, без sleep и без гонок
